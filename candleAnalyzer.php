...
$analyzer = new CandlestickAnalyzer($candleData);
...
function main4() {
 ...
 class ExtendedCandlestickAnalyzer extends CandlestickAnalyzer {
    /**
     * คำนวณ Fibonacci Retracement
     * 
     * @return array ค่า Fibonacci Retracement
     */
...
//การบันทึกประวัติและสถิติ
    ...
    public function __construct($candleData) {
        $this->analyzer = new CandlestickAnalyzer($candleData);
    }
