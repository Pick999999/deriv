...
$result = CheckOverCandleSizeB::CheckOverCandleSizeB($sampleCandles, $customConfig);

// แสดงผลลัพธ์
echo CheckOverCandleSizeB::formatResult($result);
echo "\n\n";
...
//******************
// วิเคราะห์
$result = CheckOverCandleSizeB::CheckOverCandleSizeB($sampleCandles, [
    'atr_multiplier' => 2.0,
    'volume_multiplier' => 3.0,
    'min_abnormal_conditions' => 1
]);
