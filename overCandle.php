...
$bodyResult = TradingFilters::bodySizeRatioFilter($sampleCandles, 20, 2.5);
print_r($bodyResult);
echo "<br>";

// ทดสอบ Candle Momentum Filter
echo "2. Candle Momentum Filter:<br>";
$momentumResult = TradingFilters::candleMomentumFilter($sampleCandles, 14, 2.0);
print_r($momentumResult);
echo "<br>";

// ทดสอบ Combined Filter
echo "3. Combined Filter:<br>";
$combinedResult = TradingFilters::combinedFilter($sampleCandles, [
    'body_periods' => 20,
    'body_threshold' => 2.5,
    'momentum_periods' => 14,
...
**/
// วิเคราะห์
$result = TradingFilters::combinedFilter($sampleCandles);
