...
try {
    ...
    // ซื้อ Fall contract (ตัวอย่างเพิ่มเติม)
    /*
    echo "กำลังส่งคำสั่งซื้อ Fall...<br>";
    $buyResponse = buyFallContract($client, $symbol, $duration, $duration_unit, $amount);
    ...
    if ($buyResponse) {
        ...
        trackContract($client, $buyResponse['buy']['contract_id']);
    }
    */
