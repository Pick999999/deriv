...
error_reporting(E_ALL);
 ...
 $prettyJson = json_encode($AllAnalysis, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
 ?>
 <div id="" class="bordergray flex" style='border:2px solid blue;padding:10px;'> <?php
...
$candleData  = JSON_DECODE($candleDataString,true) ;
          ...
          require_once('deriv/api/phpCandlestickIndy.php');
          $clsStep1 = new TechnicalIndicators();   

          require_once('deriv/api/phpAdvanceIndy.php');
...
///home/thepaper/domains/thepapers.in/private_html/deriv/AjaxNewTrade.php
  require_once('deriv/newDerivObject/TradingConditionAnalyzer.php');  
