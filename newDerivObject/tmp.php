...
*/
        ...
        document.getElementById('chartForm').addEventListener('submit', async (e) => {
			...
			date1 = engDate999(document.getElementById('startDate').value) ;
			date2 = engDate999(document.getElementById('endDate').value) ;
...
function engDate999(tDate) {


	     tmp = tDate.split(' ');		 
		 tmp1 = tmp[0].split('-') ;
		 engDate = tmp1[2]+'-'+tmp1[1]+'-'+ tmp1[0]+' '+ tmp[1] +":00";
		 console.log(engDate)
